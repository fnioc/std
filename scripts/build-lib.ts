...
//   | di.extras     | typesOnly: true | authoring-only package -- its members are substituted at a consumer's call site by the inline stage, never value-imported, so it ships no runtime bundle |
