...
| `HostBuilder`                                                                                                                                                | The classic, delegate-accumulating builder — `configureHostConfiguration`, `configureAppConfiguration`, `configureServices`, `configureContainer`, `build()`.                                                                     |
...
| `HostingHostBuilderExtensions`                                                                                                                               | The `IHostBuilder` fluent methods: `configureDefaults`, `useEnvironment`, `useContentRoot`, `configureHostOptions`, `configureLogging`, `configureMetrics`, `useDefaultServiceProvider`, `useConsoleLifetime`, `runConsoleAsync`. |
...
| `CONFIGURATION_TOKEN`, `HOST_ENVIRONMENT_TOKEN`, `HOST_LIFETIME_TOKEN`, `HOST_OPTIONS_TOKEN`, `HOST_BUILDER_CONTEXT_TOKEN`, `CONSOLE_LIFETIME_OPTIONS_TOKEN` | Dependency-injection tokens for resolving the corresponding framework service off `host.services`.                                                                                                                                |
