...
// set against the shared LOGGING_BUILDER_AUGMENTATION_TOKEN (docs §38): the
 ...
 * Registered against {@link LOGGING_BUILDER_AUGMENTATION_TOKEN} below and reachable
...
registerAugmentations(LOGGING_BUILDER_AUGMENTATION_TOKEN, ConsoleLoggerExtensions);
