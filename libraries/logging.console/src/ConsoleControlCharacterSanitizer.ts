// Escapes control characters that could drive terminal escape sequences.
...
export const ConsoleControlCharacterSanitizer = {
   ...
   *
   * @remarks
   * Overloaded so a definite `string` in gives a definite `string` out.
   */
  ...
  }) as { (value: string): string; (value: string | undefined): string | undefined; },
};
