...
// dist/index.d.ts. @rhombus-std/di.core stays EXTERNAL (respectExternal) so the
// published declaration imports ServiceManifest from di.core rather than
// inlining a private copy; @rhombus-toolkit/func is inlined.
