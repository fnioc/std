...
export namespace ManifestServiceAugmentations {
   ...
   */
  export function addClass<T extends AbstractCtor>(this: Manifest, type: string | Type, ctor: T & Ctor,
    implementerType: ConstructorType, scope?: string, key?: string): Manifest {
...
declare module '@rhombus-std/di.core' {
  interface Manifest<Scopes extends string> {
    addClass<T extends AbstractCtor>(type: string | Type, ctor: T & Ctor, implementerType: ConstructorType,
