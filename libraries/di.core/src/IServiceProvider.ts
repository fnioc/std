...
/**
 * The single primitive every internal implementer of resolution carries, and every internal caller
 * passes around. Never a public-facing spot — {@link IServiceProvider} holds the same primitive for
 * a consumer, with the augmented verbs layered on top of it.
 */
export interface IServiceProviderInternal {
  /**
