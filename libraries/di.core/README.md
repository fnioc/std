...
| `Addon<Lifetime>`                               | One thing a builder installs through `useAddon`: the registrations it files and the middleware it composes into the container's chain. A lifetime model — the pattern for how long a construction is kept and what keeps it — is an addon like any other.                                                                                                         |
