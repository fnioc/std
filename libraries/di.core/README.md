...
| `ObjectDisposedError`                           | A resolution or scope opening reached a provider whose container or scope is already disposed — the standard lifetime model's refusal.                                                                                                                                                                                                                            |
