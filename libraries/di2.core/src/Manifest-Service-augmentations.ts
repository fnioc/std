...
type IManifestServiceAugmentations<Scopes extends string> = {
  addClass(token: Token | Type, ctor: Ctor, signatures: Signatures, scope?: Scopes, key?: string): IManifest<Scopes>;
  addFactory(token: Token | Type, factory: Func<any[], unknown>, signatures: Signatures, scope?: Scopes,
    key?: string): IManifest<Scopes>;
  addValue(token: Token | Type, value: unknown, key?: string): IManifest<Scopes>;
};
