// Rolls the public type surface of @rhombus-std/config.extras into a
...
export default { input: join(PKG_ROOT, 'src', 'index.ts'), output: { file: join(PKG_ROOT, 'dist', 'bundle', 'index.d.ts'), format: 'es' }, external: [/^typescript$/, /^@rhombus-std\//],
