...
export function valueof<T>(): T {
  ...
  throw new Error(
    'valueof<T>() requires the @rhombus-std/di2.extras authoring transform. Depend on '
      + '@rhombus-std/di2.extras so ttsc spawns the @rhombus-std transform host, or pass '
