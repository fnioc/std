...
// dist/bundle/index.d.ts. @rhombus-std/primitives stays EXTERNAL (respectExternal) so
...
export default { input: join(PKG_ROOT, 'src', 'index.ts'), output: { file: join(PKG_ROOT, 'dist', 'bundle', 'index.d.ts'), format: 'es' }, external: [/^@rhombus-std\/primitives$/],
