...
import type { AugmentationSet2, CtorType, Flatten, IntersectionType } from '@rhombus-std/primitives';
...
interface IMetricsBuilderAugmentations {
   ...
   * argument types.
   */
  addMetricsListenerType(ctor: Ctor, implType: CtorType | IntersectionType): this;
