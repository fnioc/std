// Internal child-enumeration helper shared by the root, the manager, and every
// section: exported for the package's own call sites only, never re-exported
// from the barrel and never installed on a prototype.
 ...
 * sections of `root`.
 */
export function getChildrenImplementation(root: IConfigRoot, path: string | undefined): IConfigSection[] {
