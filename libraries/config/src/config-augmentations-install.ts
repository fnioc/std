...
// lives in core; the install -- the `applyAugmentations` calls plus the
// `declare module` merges -- must stay here, because it references the
...
// The fluent form is typed per concrete class below; an
