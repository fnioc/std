// A MemoryCacheOptions whose size limit defaults to 200 MB: the memory-backed
// IDistributedCache sizes each entry by its byte length, so the default
// bounds the cache at 200 MB of payload.
