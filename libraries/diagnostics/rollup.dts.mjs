...
export default { input: join(PKG_ROOT, 'src', 'index.ts'),
  ...
  external: [/^@rhombus-std\/config\.core$/, /^@rhombus-std\/di2\.core$/, /^@rhombus-std\/config$/,
    /^@rhombus-std\/options$/, /^@rhombus-std\/options\.augmentations$/, /^@rhombus-std\/diagnostics\.core$/,
    /^@rhombus-std\/primitives$/, /^@rhombus-std\/primitives\.extras(\/|$)/, /^@rhombus-toolkit\/func$/],
