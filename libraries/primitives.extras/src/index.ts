// Type-derivation primitives resolved at compile time, `typefor` foremost.
// Every call is elided from the shipped output, so a consumer depends on this
// package build-time only.
//
