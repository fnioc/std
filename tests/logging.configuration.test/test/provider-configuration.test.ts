...
import { type ILoggerProviderConfiguration, type ILoggerProviderConfigurationFactory,
  loggerProviderConfigurationToken } from '@rhombus-std/logging.configuration';
