...
import { ConfigurationBuilder, ConfigurationRoot, type IConfigurationBuilder, type IConfigurationProvider,
  StreamConfigurationProvider, StreamConfigurationSource, type StreamPayload } from '@rhombus-std/config';
