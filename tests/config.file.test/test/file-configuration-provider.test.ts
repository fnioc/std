// Behavior tests for the file-configuration base layer -- FileConfigurationSource
// and FileConfigurationProvider. Exercised through a minimal concrete provider
...
import { FileConfigurationProvider, FileConfigurationSource, FormatError,
  InvalidDataError } from '@rhombus-std/config.file';
...
class LinesProvider extends FileConfigurationProvider {
...
class LinesSource extends FileConfigurationSource {
  public build(builder: IConfigurationBuilder): LinesProvider {
...
describe('FileConfigurationProvider load', () => {
...
describe('FileConfigurationProvider onLoadError', () => {
...
describe('FileConfigurationProvider#toString', () => {
...
describe('FileConfigurationProvider reload', () => {
...
describe('FileConfigurationExtensions builder augmentation', () => {
