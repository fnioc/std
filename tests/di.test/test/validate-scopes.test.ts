...
function build(lifetimes: { counter: StandardLifetime; holder?: StandardLifetime; outer?: StandardLifetime; }, ...extra: Array<Addon<StandardLifetime>>): IDisposableServiceProvider {
