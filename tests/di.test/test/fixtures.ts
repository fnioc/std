...
export const T = { Logger: 'pkg:ILogger' as Token, Db: 'pkg:IDb' as Token, Repo: 'pkg:IRepo' as Token,
  Service: 'pkg:IService' as Token, Config: 'pkg:IConfig' as Token, A: 'pkg:IA' as Token, B: 'pkg:IB' as Token,
  C: 'pkg:IC' as Token } as const;

/** Generic-token fixtures for the open-generics suite. */
export const G = { RepoTemplate: 'pkg:IRepo<$1>' as Token, RepoOfA: 'pkg:IRepo<pkg:IA>' as Token,
  RepoOfB: 'pkg:IRepo<pkg:IB>' as Token } as const;
...
export class SyncDisposable implements Disposable {
  ...
  public constructor(public readonly label: string, private readonly log: DisposeLog) {}
