...
import { IniStreamConfigSource } from '@rhombus-std/config.ini';
...
function fromIni(text: string): IndexedSection {
  return new ConfigBuilder().add(new IniStreamConfigSource(text)).build();
}
...
describe('IniConfigSource file wiring', () => {
