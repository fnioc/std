...
~~Full text migrated to `decisions.v2.md` §72 and struck here — never read for behavior.~~
...
~~Full text migrated to `decisions.v2.md` §74 and struck here — never read for behavior.~~
