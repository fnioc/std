...
// `@rhombus-std/examples.contracts` types (`Type.import(exportedName, // importSpecifier)`). Writing the derived form by hand is what lets this
...
//
// `Type` nodes are INTERNED: this file's `Type.import('IGreeting', // '@rhombus-std/examples.contracts')` and the with-transformer library's
...
export const GREETING_TYPE: Type = Type.import('IGreeting', '@rhombus-std/examples.contracts');

/** The optional service this library alone registers. */
export const HEALTH_CHECK_TYPE: Type = Type.import('IHealthCheck', '@rhombus-std/examples.contracts');
